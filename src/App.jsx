  ...
  <tr>
    <td style="padding: 0; vertical-align: top;">
      <table cellpadding="0" cellspacing="0" border="0" style="width: 100%; border-collapse: collapse;">
        ...
        ${logoUrl ? `<tr><td style="padding: 0 0 8px 0;"><a href="${companyWebsite || '#'}" style="text-decoration: none;"><img src="${logoUrl}" alt="${company || 'Company'}" style="max-width: 120px; height: auto; border: 0;" /></a></td></tr>` : ''}
